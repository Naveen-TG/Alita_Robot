...
import time
import uuid
from alita.mongo.feddb import *
import html
from alita.utils.custom_filters import owner_filter
from alita.utils.filter_groups import *
import asyncio
from pyrogram.types import InlineKeyboardButton,InlineKeyboardMarkup
from alita.utils.functions import extract_user
import asyncio
from button import *

                                              
@Alita.on_message(filters.command("joinfed") & owner_filter )
...
@Alita.on_message(filters.command("leavefed") & owner_filter )
...
@Alita.on_message(filters.command("fedinfo") & owner_filter )
...
@Alita.on_message(filters.command("newfed"))
...
@Alita.on_message(filters.all & filters.group, group=fban)
...
@Alita.on_message(filters.command("fedpromote"))
...
@Alita.on_message(filters.command("fban"))
...
@Alita.on_message(filters.command("unfban"))
...
@Alita.on_message(filters.command("renamefed"))
